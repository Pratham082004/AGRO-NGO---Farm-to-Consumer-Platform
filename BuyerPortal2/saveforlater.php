        ...
        <div class="row">
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    ...
                    <img class="card-img-top" src="../Images/Fruits/orange.jpg" alt="Card image">
                    <div class="card-body">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card  pl-3 pr-3 pb-0 pt-2 mt-2 ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> RAJU
                        </b></h3>
                    </div>
                    <img class="card-img-top" src="../Images/Fruits/Mango.jpg" alt="Card image">
                    <div class="card-body">
            ...
            <div class="col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4">
                <div class="card pl-3 pr-3 pb-0 pt-2 mt-2  ">
                    <br>
                    <div><b>
                            <h3><img src="iconsmall.png"> POOJA
                        </b></h3>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    ...
                    <p class="h6">Developed in 2026.<a class="text-green ml-2" href="https://www.google.com" target="_blank">All rights reserved.</a></p>
 </div>
                </hr>
            </div>
        </div>
