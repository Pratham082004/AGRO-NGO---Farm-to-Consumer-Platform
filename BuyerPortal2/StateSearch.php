...
<head>
    ...
    <title>State Produce Search: <?php echo htmlspecialchars($state); ?> — AgroNGO</title>
    ...
    <div class="agro-page-header" style="background: var(--surface-primary); border-bottom: 1px solid var(--gray-200);">
        <div class="agro-container">
            <div class="agro-page-header__breadcrumb">
                <a href="bhome.php">Home</a> / <span>State Search</span>
            </div>
            <h1 class="agro-page-header__title">Produce in <?php echo htmlspecialchars($state ? $state : 'Select State'); ?></h1>
            <p class="agro-page-header__desc">Explore fresh agricultural harvests from farmers in this state.</p>
        </div>
    </div>
    ...
    <div class="agro-container agro-section">
                    ...
                    <div class="agro-product-card">
                        ...
                        <div class="agro-product-card__body">
                            ...
                            <div class="agro-product-card__footer agro-mt-4">
                                ...
                                <a href="StateSearch.php?state=<?php echo urlencode($state); ?>&add_cart=<?php echo $product_id; ?>" class="agro-btn agro-btn--secondary agro-btn--sm">
        ...
        <?php else: ?>
            <div class="agro-empty">
                ...
                <h3 class="agro-empty__title">No Produce Found in <?php echo htmlspecialchars($state); ?></h3>
                <p class="agro-empty__desc">No farmers in this state currently have produce listed. Try browsing all categories.</p>
