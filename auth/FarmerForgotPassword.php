...
<head>
    ...
    <title>Forgot Password — Farmer — AgroNGO</title>
    <meta name="description" content="Reset your AgroNGO Farmer account password.">
...
<body style="display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <div class="agro-auth" style="flex: 1; padding: var(--space-12) var(--space-4);">
        <div class="agro-auth__card">
            ...
            <p class="agro-auth__subtitle">Enter your details to update your farmer account password</p>

            <form action="FarmerForgotPassword.php" method="post" id="farmer-forgot-form">
                ...
                <button type="submit" name="register" class="agro-btn agro-btn--primary agro-btn--full agro-btn--lg">
                    <i class="fas fa-key"></i> Update Password
                </button>

                <div class="agro-auth__links" style="justify-content: center; margin-top: var(--space-5);">
                    <a href="FarmerLogin.php"><i class="fas fa-arrow-left" style="margin-right:4px;"></i> Back to Login</a>
                </div>
            </form>
        </div>
    </div>
